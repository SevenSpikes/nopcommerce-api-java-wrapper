...
public interface NopCommerceClient
{
    ...
    CustomerList getCustomers(@Param("limit") Integer limit, @Param("page") Integer page, @Param("since-id") long sinceId, @Param("fields") String fields);

    @RequestLine("GET /api/categories?limit={limit}&since_id={since-id}&page={page}&fields={fields}")
    CategoryList getCategories(@Param("limit") Integer limit, @Param("page") Integer page, @Param("since-id") long sinceId, @Param("fields") String fields);

    @RequestLine("GET /api/products?limit={limit}&since_id={since-id}&page={page}&fields={fields}&published_status={published-status}")
    ProductList getProducts(@Param("limit") Integer limit, @Param("page") Integer page, @Param("since-id") long sinceId, @Param("published-status") PublishedStatus publishedStatus, @Param("fields") String fields);

    @RequestLine("GET /api/product_category_mappings?limit={limit}&since_id={since-id}&page={page}&fields={fields}")
    ProductCategoryMappingList getProductCategoryMappings(@Param("limit") Integer limit, @Param("page") Integer page, @Param("since-id") long sinceId, @Param("fields") String fields);

    @RequestLine("GET /api/orders?limit={limit}&since_id={since-id}&page={page}&fields={fields}")
    OrderList getOrders(@Param("limit") Integer limit, @Param("page") Integer page, @Param("since-id") long sinceId, @Param("fields") String fields);
    ...
    NewsLetterSubscriptionList getNewsLetterSubscriptions(@Param("limit") Integer limit, @Param("page") Integer page, @Param("since-id") long sinceId, @Param("fields") String fields);
